 ...
 * @author user1
 */
public class SalesQuery extends Admin{
    String message = "";
        ...
        find.setOnMouseClicked(e->{
            if(!field.getText().isEmpty()){
                ...
                this.resetPageVariable("select * from invoice where invoice like '"+field.getText()+
                        "%' or customer like'"+field.getText()+"%' or seller like'"+field.getText()+
    ...
    public void resetPageVariable(String q1, String q2){
        if(q2 != null && !q2.isEmpty()){
            ...
            query2 = "select count(*) from invoice";
        }
        if(q1 != null && !q1.isEmpty()){
           query1 = q1;
        }else{
           query1 = "select * from invoice order by id desc";
        }
